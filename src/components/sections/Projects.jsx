...
const PROJECTS = [
  ...
  },
  {
    ...
    architecture: [
      ...
      'Engineered modular REST service structure with comprehensive Postman API validation and Git versioning.',
    ],
    tech: ['Node.js', 'Express', 'MongoDB', 'JWT/RBAC', 'Git & GitHub', 'REST APIs', 'Postman'],
