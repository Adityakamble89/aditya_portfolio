...
const TECH_ITEMS = [
  ...
  //   name: 'Docker',
  //   category: 'DevOps',
  //   role: 'Multi-stage containerization & isolated environments',
  //   color: '#0284C7',
  //   icon: Boxes,
  // },
  // {
  ...
  // },
  {
    name: 'React.js',
    category: 'Frontend',
    role: 'Dynamic dashboard state management & micro-frontends',
    color: '#38BDF8',
    icon: Layers,
  },
  {
    name: 'Python',
    category: 'Language',
    role: 'AI integrations, data engineering & automation scripts',
    color: '#FACC15',
    icon: Cpu,
  },
  {
  ...
  //   role: 'EC2, S3 asset buckets & scalable deployment',
  //   color: '#F97316',
  //   icon: Cloud,
  // },
  {
    name: 'Git & Github',
    category: 'Workflows',
    role: 'Version control, automated linting & test pipelines',
    color: '#F43F5E',
    icon: Terminal,
  },
];
